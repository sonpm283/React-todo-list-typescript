...
Nếu muốn setting mỗi workspace hiện tại thôi (nghĩa là cái folder hiện tại) thì các bạn setting bên workspace
...
Trên là những plugin cần thiết để setting Pretter và Eslint cho CRA. nếu dùng yarn thì chạy `yarn add`.
